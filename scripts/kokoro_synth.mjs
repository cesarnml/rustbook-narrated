#!/usr/bin/env node
/**
 * Kokoro synthesis backend using kokoro-js.
 *
 * Weights (Apache-2.0, ~86 MB at q8) are fetched from huggingface.co on first
 * run and cached by transformers.js.
 *
 ...
 *
 * Ported from zed-rust-for-dummies's scripts/kokoro_synth.mjs, unchanged
 * apart from the model constant's env var name.
 */
